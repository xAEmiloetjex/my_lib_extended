...
import { Vec } from '../../lib/vector/index.js';
        ...
        if (me === undefined) {
            if (common.HelloStruct.verify(view)) {
                me = {
                    ...
                    pos: new Vec<number>(common.HelloStruct.x.read(view), common.HelloStruct.y.read(view)).allowUnsafe(true).readable(false),
                    moving: 0,
            ...
            if (common.PlayersJoinedHeaderStruct.verify(view)) {
                ...
                for (let i = 0; i < count; ++i) {
                    ...
                    if (player !== undefined) {
                        ...
                        player.pos.set('x', common.PlayerStruct.x.read(playerView));
                        player.pos.set('y', common.PlayerStruct.y.read(playerView));
